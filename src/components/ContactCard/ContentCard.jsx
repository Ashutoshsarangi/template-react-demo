...
const ContentCard = ({ imageSrc, name, phoneNo, phoneTxt }) => {
  ...
  return (
    <div className="m-3 p-3 border-lime-100 shadow">
      ...
      <div className="space-y-2">
        <h2 className="text-2xl text-slate-600 dark:text-slate-100">
          {name} ({phoneTxt})
        </h2>
        <p className="mb-3 text-slate-500 dark:text-slate-100">
          {t("feel_free_reach_out_us")}
        </p>
      </div>
    </div>
  );
